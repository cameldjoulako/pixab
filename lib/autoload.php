<?php
/* mise en place du chargement automatique des classe presente dans l'application */
const ALIASES = [
    'Pixab' => 'lib',
    'App' => 'src'
];
...
spl_autoload_register(function (string $class): void {
    ...
    if (in_array($namespaceParts[0], array_keys(ALIASES))) {
        ...
        throw new Exception('Namespace « ' . $namespaceParts[0] . ' » invalide. Un namespace doit commencer par : « Pixab » ou « App »');
    }
